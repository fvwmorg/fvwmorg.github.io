...
// Usage:
// ls *jpg | grep -v small | sed 's+.jpg++;s+.*+sed "s/Uwe Pross/&/g" template.php_ > &.php+' | sh
...
<img src="Uwe_Pross.jpg" border="0" hspace="10" vspace="10"><br>

<a href="http://www-user.tu-chemnitz.de/~uwp/">Personal Website</a>
