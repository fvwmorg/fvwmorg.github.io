...
#### Any WWW Sites about fvwm?
  ...
  Yup.  The official site is: <http://www.fvwm.org>
...
#### What version of fvwm should I use?

  You should be running the current version of fvwm
  which can be found at <http://github.com/fvwmorg/fvwm>.

  Older versions prior to 2.6.x should be upgraded as they
...
#### I want to use fvwm, but I don't have root access on my machine. Can I still install and run it?
  ...
  fvwm sources, do:
    ...
    ./configure --prefix=/home/sam [other options as needed]
