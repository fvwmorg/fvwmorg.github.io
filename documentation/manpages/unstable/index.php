...
<?php decoration_window_start("Manual page for index in unstable branch (2.5.28)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 20-Sep-2009 by viktor,
	from the 2.5.x man pages.<!-- in directory ../../../release. -->
