...
<?php decoration_window_start("Manual page for index in unstable branch (2.5.25)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 08-Jan-2008 by viktor,
	from the 2.5.x man pages.<!-- in directory ../../../fvwm-truehead/. -->
	...
	<ul>
			...
			<li><a href="<?php echo conv_link_target('./fvwm.php');?>">fvwm</a>
			<li><a href="<?php echo conv_link_target('./fvwm.php');?>">fvwm</a>
			<li><a href="<?php echo conv_link_target('./.#fvwm.de.gmo.1.php');?>">.#fvwm.de.gmo.1</a>
			<li><a href="<?php echo conv_link_target('./.#fvwm.fr.gmo.1.php');?>">.#fvwm.fr.gmo.1</a>
			<li><a href="<?php echo conv_link_target('./.#fvwm.sv_SE.gmo.1.php');?>">.#fvwm.sv_SE.gmo.1</a>
			<li><a href="<?php echo conv_link_target('./.#fvwm.zh_CN.po.1.php');?>">.#fvwm.zh_CN.po.1</a>
			<li><a href="<?php echo conv_link_target('./.#modules.html.1.php');?>">.#modules.html.1</a>
