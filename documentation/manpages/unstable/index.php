...
<?php decoration_window_start("Manual page for index in unstable branch (2.5.20)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 15-Jan-2007 by griph,
	from the 2.5.x man pages.<!-- in directory ../../../fvwm-cvshead. -->
