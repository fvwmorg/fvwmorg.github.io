...
<?php decoration_window_start("Manual page for index in unstable branch (2.5.30)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 09-May-2010 by n6tadam,
	...
	<ul>
			...
			<li><a href="<?php echo conv_link_target('./title-format.patch.php');?>">title-format.patch</a>
		</ul>
