...
$this_site      = "manpages_unstable_FvwmGtk";
...
<?php decoration_window_start("Manual page for FvwmGtk in unstable branch (2.5.32)"); ?>
...
<P>
<B><u>FvwmGtk</u></B> gets config info from <B>fvwm</B>'s module configuration
database (see
