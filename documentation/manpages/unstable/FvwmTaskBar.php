...
<?php decoration_window_start("Manual page for FvwmTaskBar"); ?>

<H1>FvwmTaskBar</H1>
Section: FVWM Modules (1)<BR>Updated: 9 September 2002<BR><A HREF="#index">This page contents</A>
...
It is a <I><A HREF=".//3+strftime">strftime</A>(3)</I> compatible format string.
