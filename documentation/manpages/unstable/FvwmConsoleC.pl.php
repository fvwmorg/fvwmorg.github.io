...
$heading        = "Man page - FvwmConsoleC.pl";
$link_name      = "Man page";
...
<?php decoration_window_start("Manual page for FvwmConsoleC.pl"); ?>
...
<A HREF=".//1x+FvwmConsole">FvwmConsole</A>(1x), <A HREF=".//1+perlre">perlre</A>(1)
<P>
<A NAME="lbAJ">&nbsp;</A>
<H2>AUTHOR</H2>
