...
<?php decoration_window_start("Manual page for FvwmIconBox in unstable branch (2.5.32)"); ?>
...
During initialization, <I>FvwmIconBox</I> gets config info from <B>fvwm</B>'s
