...
<?php decoration_window_start("Manual page for fvwm-root in unstable branch (2.5.32)"); ?>
...
RootTransparent colorset option, refer to the COLORSETS section of <A HREF="/cgi-bin/man/man2html/1+fvwm">fvwm</A>(1).
