...
$heading        = "Man page - FvwmWindowMenu";
$link_name      = "Man page";
...
<?php decoration_window_start("Manual page for FvwmWindowMenu"); ?>
...
See <I><A HREF=".//1+perlre">perlre</A></I>(1).
<P>
...
expressions that will be evaluated in m// context. See <I><A HREF=".//1+perlre">perlre</A></I>(1).
<P>
