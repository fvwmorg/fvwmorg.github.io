...
<?php decoration_window_start("Manual page for FvwmWindowMenu in unstable branch (2.5.32)"); ?>
...
FvwmWindowMenu should be spawned by <I><A HREF="/cgi-bin/man/man2html/1+fvwm">fvwm</A></I>(1) for normal functionality.
<P>
