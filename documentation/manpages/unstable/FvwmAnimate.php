...
<?php decoration_window_start("Manual page for FvwmAnimate in unstable branch (2.5.32)"); ?>
...
<B><u>FvwmAnimate</u></B> must be invoked by the <B>fvwm</B> window manager.
...
<P>
<B><u>FvwmAnimate</u></B> gets configuration info from <B>fvwm</B>'s module configuration
database (see
<I><A HREF="/cgi-bin/man/man2html/1+fvwm">fvwm</A></I>(1),
