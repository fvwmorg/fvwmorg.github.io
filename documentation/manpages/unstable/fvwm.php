...
<H1>FVWM</H1>
Section: Fvwm 2.5.24 (from cvs) (1)<BR>Updated: (not released yet)<BR><A HREF="#index">This page contents</A>
...
<DL COMPACT><DT><DD>
The window's name, icon name, resource class and resource name, file name of its icon or mini icon defined with the
<I>Icon</I>
or
<I>MiniIcon</I>
...
<P>
Note, the first 4 variables may include any kind of characters, so these variables are quoted.  It means that the value is surrounded by single quote characters and any contained single quote is prefixed with a backslash.  This guarantees that commands like:
<P>
<DL COMPACT><DT><DD>
<PRE>
...
<P>
<DL COMPACT><DT><DD>
*<B>Commands affecting window movement and placement</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>Commands for focus and mouse movement</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>Commands controlling window state</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>Commands for mouse, key and stroke bindings</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>The Style command (controlling window styles)</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>Other commands controlling window styles</B>
<P>
</DL>

<P>
<DL COMPACT><DT><DD>
*<B>Commands controlling the virtual desktop</B>
<P>
</DL>
...
<P>
<DL COMPACT><DT><DD>
*<B>Quit, restart and session management commands</B>
<P>
</DL>
...
screen (containing the mouse pointer), '<I>g</I>' for the global screen
...
<I>ResizeHintOverride</I> / <I>!ResizeOverride</I>,
...
<DT><B>EdgeResistance</B> <I>scrolling</I> <I>moving</I> [<I>xinerama-scrolling</I>]<DD>
<DL COMPACT><DT><DD>
...
Time: 20:58:01 GMT, September 01, 2007
