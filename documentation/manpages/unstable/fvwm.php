...
</pre></div><p>This would hence place the window called <span class="emphasis"><em>MyWindow</em></span>
on page 0 0 for the current desk, and immediately run the <a href="#Iconify">Iconify</a>
command on that window.</p><div class="section" lang="en"><div class="titlepage"><div><div><h5 class="title"><a name="window_manager_placement"></a>31.7.5.7. Window Manager placement</h5></div></div></div><p>Applications can place windows at a particular spot on the screen
