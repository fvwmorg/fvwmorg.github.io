...
likely safe to leave this option at its default.</p><p><a name="BugOpts_EWMHIconicStateWorkaround"></a><font class="fvwmopt">EWMHIconicStateWorkaround</font>
...
<em class="replaceable"><code>verbose</code></em>
can be 1.</p></div><div class="section" lang="en"><div class="titlepage"><div><div><h4 class="title"><a name="Repeat"></a>31.2.26. Repeat</h4></div></div></div><div class="cmdsynopsis"><p><code class="command">Repeat</code> </p></div><p>When the
...
<span class="emphasis"><em>MwmDecor</em></span> / <span class="emphasis"><em>!DecorHint</em></span>,
<span class="emphasis"><em>MwmFunctions</em></span> / <span class="emphasis"><em>!FuncHint</em></span>,
<span class="emphasis"><em>HintOverride</em></span> / <span class="emphasis"><em>!Override</em></span>,
<span class="emphasis"><em>!Button</em></span> / <span class="emphasis"><em>Button</em></span>,
<span class="emphasis"><em>ResizeHintOverride</em></span> / <span class="emphasis"><em>!ResizeOverride</em></span>,
...
command.</p><p>The <em class="replaceable"><code>behavior</code></em> argument is optional
...
and windows do not snap.</p><p>If the <em class="replaceable"><code>behavior</code></em> option is not
given, the snapping behavior is not changed.  The default behavior
is <span class="emphasis"><em>All</em></span>.</p><p>If the <em class="replaceable"><code>Screen</code></em> option is present
windows and or icons are snapped to the screen edges too.</p><p>The option <a name="Style_SnapGrid"></a><font class="fvwmopt">SnapGrid</font> defines an
...
parameters.</p></div><div class="section" lang="en"><div class="titlepage"><div><div><h5 class="title"><a name="window_manager_placement"></a>31.7.5.7. Window Manager placement</h5></div></div></div><p>Applications can place windows at a particular spot on the screen
