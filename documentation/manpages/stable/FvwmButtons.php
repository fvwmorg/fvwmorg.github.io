...
<?php decoration_window_start("Manual page for FvwmButtons in stable branch (2.4.16)"); ?>
...
<B>] [-transient | -transientpanel]</B>

<I>[ name [ config file ] ]</I>
...
<I>filename</I>. <I>Filename</I> can be a full pathname, or is
...
Specifies the font to be used for labeling the buttons, or <I>None</I>.
<P>
...
This option works like the <I>Geometry</I> option except that
...
The button is <I>width</I> times the normal button width
and <I>height</I> times the normal button height. If values for <I>x</I> and
<I>y</I> are given, the button is placed x (y) button units from the left
...
by pressing return or a mouse button. The <I>command</I> needs to be
quoted if it contains a comma or a closing parenthesis. You can use a
number of predefined variables: <I>$left</I>, <I>$right</I>, <I>$top</I>
and <I>$bottom</I> are substituted by the left, right, top and bottom
coordinates of the button pressed. <I>$-left</I>, <I>$-right</I>,
<I>$-top</I> and<I>$-bottom</I> are substituted likewise, but the
coordinates are calculated from the bottom or the
right edge of the screen instead (for a button that is 5 pixels away
from the right screen border, $-right will be 5). <I>$width</I>
and <I>$height</I> are replaced by the width or height of the button.
The variables <I>$fg</I> and <I>$bg</I> are replaced with the name
of the foreground or background color set with the <I>Back</I>
or <I>Fore</I> option (see below). All this is done regardless of
...
<P>
The current options of the <I>Action</I> are:
<P>
Mouse <I>n</I> - this action is only executed for mouse button <I>n</I>.
...
may be changed by <I>Left</I> or <I>Right</I>.
<P>
...
For an example, see the <I>Sample configuration</I> section.
<P>
...
Specifies that the font <I>fontname</I> is to be used for labeling this button.
<P>
<DT>Fore <I>color</I><DD>
Specifies the foregound color of the title and monochrome icons in this button.
<P>
<DT>Frame <I>width</I><DD>
The relief of the button will be <I>width</I> pixels wide. If <I>width</I>
...
buttons with the <I>Swallow</I> command below, but they are not displayed
...
application) opens with a sliding animation.  The <I>options</I> can
be any of the <I>flags</I> described for the Swallow command.  In addition
...
animation steps.
<P>
The <I>delay ms</I> option sets the delay between the steps
...
<P>
The <I>smooth</I> option causes the panel  to  redraw  between
...
in the direction where the panel will pop up.  The <I>indicator</I>
...
You will probably want to use the <I>Padding</I> option to leave a
few pixels between the indicator and the frame of the button.
<P>
The <I>position</I> option allows to place the panel. The syntax is:
<PRE>
...
The argument <I>context-window</I> can be one of: Button, Module or Root.
The  <I>context-window</I> is the window from which panel percentage
...
<P>
The <I>pos</I> argument can be one of: center, left or right (for sliding up
...
<P>
The <I>border-opts</I> are: mlr, mtb, noplr and noptb.
...
Causes FvwmButtons to execute <I>command</I>, and when a window matching the
name <I>hangon</I> appears, it is captured and swallowed into this button.
Swallow replaces the variables <I>$fg</I> and <I>$bg</I> as described
above for the <I>Action</I> option (but if you use the UseOld and NoClose
...
<I>command</I>. Use this option with care, the program might have a
...
Title <I>name</I>. If the title field is &quot;-&quot;, no title is displayed.
The <I>icon</I> field is similar to the option
Icon <I>filename</I>. If the icon field is &quot;-&quot; no icon is displayed.
...
See <a href="<?php echo conv_link_target('./fvwm2.php');?>">fvwm2</a>(1) for more infomation.
<P>
...
other button.  Essentially you need nothing more than the <I>Panel</I>
option:
<P>
<PRE>
...
<P>
This works like the <I>Swallow</I> option.  The
...
description of the <I>Swallow</I> option.
<P>
...
the title use the fvwm <I>Style</I> command.  If your button bar
...
<I>-transientpanel</I> option after the -g option in the command.
...
above and the <I>Padding</I> option to leave a few pixels between
...
refer to the description of the <I>Panel</I> option for further details.
<P>
<A NAME="lbAJ">&nbsp;</A>
...
columns from that.
If the BoxSize option is set to <I>smart</I> at least the height/width of
the tallest/widest button is used while the <I>fixed</I> value prevents the
box from getting resized if both <I>rows</I> and <I>columns</I> have been set
to non-zero.
...
are placed if necessary if the BoxSize option <I>smart</I> is used.
<DT>Containers<DD>
...
<P>
The final line is even more magic. Note the combination of <I>UseOld</I>
...
<DT><A HREF="#lbAM">SAMPLE CONFIGURATION</A><DD>
...
Time: 01:39:43 GMT, April 19, 2003
