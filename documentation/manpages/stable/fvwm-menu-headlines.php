...
$heading        = "Man page - fvwm-menu-headlines";
$link_name      = "Man page";
...
<?php decoration_window_start("Manual page for fvwm-menu-headlines"); ?>
...
LinuxFr, ThinkGeek, <FONT>CNN</FONT>, BBC-World, BBC-SciTech and more.
<P>
...
<blockquote><pre>  %h - headline
  ...
  %[strftime-argument-string] - date/time, see <A HREF=".//3+strftime">strftime</A>(3)
