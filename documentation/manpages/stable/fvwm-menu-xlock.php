...
$heading        = "Man page - fvwm-menu-xlock";
$link_name      = "Man page";
...
<?php decoration_window_start("Manual page for fvwm-menu-xlock"); ?>
...
Please see the <B><A HREF=".//1+xlock">xlock</A></B>(1) man page for the xlock options.
<A NAME="lbAF">&nbsp;</A>
<H2>USAGE</H2>
