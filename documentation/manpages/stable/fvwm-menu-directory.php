...
$heading        = "Man page - fvwm-menu-directory";
$link_name      = "Man page";
...
<?php decoration_window_start("Manual page for fvwm-menu-directory"); ?>
...
<blockquote><pre>  # AddToFunc FuncFvwmMenuDirectory
  # + I PipeRead &quot;fvwm-menu-directory -d '$0' -x 'Eterm -g 80x40 -e' -a -l -o 6 --exec-app --exec-title 'tcsh -l' --exec-file 'vim -R' -t 'Go to: %d' --wm-icons&quot;</pre></blockquote>
<P>
...
Time: 02:56:44 GMT, April 17, 2003
