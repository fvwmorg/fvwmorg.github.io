...
<?php decoration_window_start("Manual page for index in stable branch (2.4.16)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 30-May-2003 by migo,
	from the 2.4.x man pages.<!-- in directory ../../../fvwm-2.4.x. -->

	<hr>
	Start of man pages in section 1.
	<ul>
			<li><a href="<?php echo conv_link_target('./fvwm2.php');?>">fvwm2</a>
			...
			<li><a href="<?php echo conv_link_target('./fvwm24_convert.php');?>">fvwm24_convert</a>
			<li><a href="<?php echo conv_link_target('./fvwmbug.php');?>">fvwmbug</a>
			<li><a href="<?php echo conv_link_target('./fvwmrc_convert.php');?>">fvwmrc_convert</a>
			<li><a href="<?php echo conv_link_target('./xpmroot.php');?>">xpmroot</a>
		</ul>
