...
$this_site      = "manpages_stable_index";
...
<?php decoration_window_start("Manual page for index in stable branch (2.6.1)"); ?>

	<h1>Index</h1>
	<hr>
	These pages were last generated on 16-Apr-2011 by n6tadam,
	from the 2.6.x man pages.<!-- in directory ../../../fvwm-2.6.x. -->
