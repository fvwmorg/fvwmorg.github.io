...
<?php decoration_window_start("Manual page for FvwmPager"); ?>
...
<P>
All desks with desk numbers between <I>first desk</I> and <I>last desk</I> are
displayed. If <I>last desk</I> is omitted only the <I>first desk</I> is shown.
If both desk numbers are omitted, the current desk is used instead. If you
use an asterisk '*' in place of <I>first desk</I> the pager will always show
...
<P>
If the pager is started with the <I>-transient</I> option, the next time
...
<P>
With the <I>*FvwmPager: SloppyFocus</I> option the focus is transfered
...
During initialization, <I>FvwmPager</I> gets config info from <B>fvwm</B>'s
...
as its <I>name</I> instead (e.g &quot;Module FvwmPager OtherPager&quot;).
...
Useful for canceling the effect of the <I>LabelsBelow</I> option.
<P>
...
Useful for canceling the effect of the <I>ShapeLabels</I> option.
<P>
<DT>*FvwmPager: Font <I>font-name</I><DD>
Specified a font to use to label the desktops.  If <I>font_name</I> is
...
be fairly useless for desktop scales of 32 or greater.  If <I>font_name</I>
...
for canceling the effect of the <I>NoDeskHilight</I> option.
<P>
...
<I>hiFore</I> specify the colors as used for the font inside the windows.
<I>back</I> and <I>hiBack</I> are used to fill the windows with.
<P>
...
Assigns the text <I>label</I> to desk <I>desk</I> (or the current desk
...
Assigns the color <I>color</I> to desk <I>desk</I> (or the current desk if
desk is &quot;*&quot;) in the pager window. This replaces the background color for
the particular <I>desk</I>.  This only works when the pager is full sized.
When Iconified, the pager uses the color specified by *FvwmPager: Back.
<P>
<B>TIP:</B><TT>&nbsp;&nbsp;&nbsp;</TT>Try using *FvwmPager: DeskColor in conjunction with<BR>
...
Assigns the pixmap <I>color</I> to desk <I>desk</I> (or the current desk if
desk is &quot;*&quot;) in the pager window. This replaces the background pixmap for
the particular <I>desk</I>.
<P>
<B>TIP:</B> Try using *FvwmPager: DeskPixmap in conjunction with FvwmCpp
...
to its original position when the button is released. If <I>pixels</I> is
less than zero the default value is used. The value set with the
<I>MoveThreshold</I> command in fvwm is inherited by FvwmPager but can
...
If <I>type</I> is <I>Pager</I> balloons are just shown for an un-iconified
pager; if <I>type</I> is <I>Icon</I> balloons are just shown for an
iconified pager. If <I>type</I> is anything else (or null) balloons are
always shown.
<P>
...
Specifies a font to use for the balloon text. Defaults to <I>fixed</I>.
<P>
...
set as an offset. Negative offsets of <I>-n</I> are placed <I>n</I>
pixels above the pager window, positive offsets of <I>+n</I> are placed
<I>n</I> pixels below. Offsets of -1 and 1 represent the balloon window
...
The same as <I>*FvwmPager: WindowLabelFormat</I>, it just specifies the string to
display in the balloons. The default is &quot;%i&quot;.
<P>
<DT>*FvwmPager: Colorset <I>desk colorset</I><DD>
Tells the module to use colorset <I>colorset</I> for <I>desk</I>.
If you use an asterisk '*' in place of <I>desk</I>, the colorset is
...
Tells the module to use colorset <I>colorset</I> for balloons on <I>desk</I>.
If you use an asterisk '*' in place of <I>desk</I>, the colorset is
used on all desks. Please refer to the man page of the FvwmTheme
module for details about colorsets.
<DT>*FvwmPager: HilightColorset <I>desk colorset</I><DD>
Tells the module to use colorset <I>colorset</I> for hilighting on <I>desk</I>.
If you use an asterisk '*' in place of <I>desk</I>, the colorset is
used on all desks. Please refer to the man page of the FvwmTheme
module for details about colorsets.
...
the minimum size of the mini windows to (2 * <I>n</I> + 1).
The default is 1.
