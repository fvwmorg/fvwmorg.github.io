...
<?php decoration_window_start("Manual page for FVWM::EventNames in unstable branch (2.5.14)"); ?>

<H1>FVWM::EventNames</H1>
Section: FVWM Perl library (3)<BR>Updated: 2005-08-24<BR>Source: <a href="ftp://ftp.fvwm.org/pub/fvwm/devel/sources/perllib/FVWM/EventNames.pm">FVWM/EventNames.pm</a><br>
...
<B>eventArgValues</B>) or a number of actual values.
The returned array has the same number of elements.
<DT><B>eventLoopArgNames</B> <I>type</I> <I>argValues</I><DD>
<A NAME="ixAAJ"></A>
Returns array ref of looped argument names of the event type (or undef).
<DT><B>eventLoopArgTypes</B> <I>type</I> <I>argValues</I><DD>
<A NAME="ixAAK"></A>
