...
<?php decoration_window_start("Manual page for FVWM::Tracker in unstable branch (2.5.7)"); ?>

<H1>FVWM::Tracker</H1>
Section: FVWM Perl library (3)<BR>Updated: 2003-05-31<BR>Source: <a href="ftp://ftp.fvwm.org/pub/fvwm/devel/sources/perllib/FVWM/Tracker.pm">FVWM/Tracker.pm</a><br>
...
it defines a common Tracker <FONT>API</FONT>, like a way to access the tracked data
...
FVWM::Tracker::ModuleConfig, <a href="<?php echo conv_link_target('./FVWM::Tracker::PageInfo.php');?>">FVWM::Tracker::PageInfo</a>,
FVWM::Tracker::Scheduler, <a href="<?php echo conv_link_target('./FVWM::Tracker::WindowList.php');?>">FVWM::Tracker::WindowList</a>.
<P>
