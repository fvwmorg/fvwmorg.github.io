...
<tr>
<td><a href="#2.6.5" style="font-weight:normal;">&nbsp;2.6.5&nbsp;</a></td>
...
<a name="2.6.5"></a>
<h4>Changes in 2.6.5 (20-Apr-2012) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:</li>
  <li> N/A</li>
  <li> Bug fixes:</li>
...
<ul>
  <li> New features:</li>
  <li> FvwmPager now wraps window names if SmallFont is set.</li>
  <li> Bug fixes:</li>
  <li> Made signals registered with FVWM unblocking.</li>
  <li> The &quot;UnderMouse&quot; option to PositionPlacement now honors the EWMH    working area by default, if it's in use.</li>
  <li> FvwmButtons handles the deleted window correctly for sub-windows.</li>
</ul>
...
<a name="2.6.3"></a>
<h4>Changes in stable release 2.6.3 (30-Sept-2011) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:</li>
  <li> New Style commands:
    <ul>
        <li>        TitleFormat</li>
        <li>        IconTitleFormat</li>
        <li>        Used to specify a window's visible name.  These new options</li>
        <li>        deprecate the older styles:</li>
        <li>        IndexedWindowName</li>
        <li>        IndexedIconName</li>
        <li>        ExactWindowName</li>
        <li>        ExactIconName</li>
    </ul>
  </li>
  <li> New Resize argument to direction: &quot;automatic&quot; which works out,    automatically, which direction a window should be resized in    based on which quadrant the pointer is in on the window -- this    is best observed by the grid formed from &quot;ResizeOutline&quot;, as the    shape of this grid is used when calculating this.    Furthermore, the existing option of &quot;warptoborder&quot; can be used in    conjunction with &quot;direction automatic&quot; to warp the pointer to the    appropriate window edge.</li>
  <li> Couple of changes to the Move command:</li>
  <li> The EWMH working area is now honoured by default.</li>
  <li> To move a window ignoring the working area, the option          &quot;ewmhiwa&quot; can be used, similar to how the Maximize          command works.</li>
  <li> New expansion placeholder $[pointer.screen] to return the screen number    the pointer is on.</li>
  <li> Bug fixes:</li>
  <li> A few minor ones; nothing user-visible per se.</li>
</ul>
...
<a name="2.6.1"></a>
<h4>Changes in stable release 2.6.1 (16-Apr-2011) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:  None.</li>
  <li> Bug fixes:</li>
  <li> Make the version and check of Fribidi &gt;= 0.19.2</li>
  <li> fvwm-menu-desktop:</li>
  <li> Make XML::Parser check runtime as it's a non-standard          module.</li>
  <li> Fix perl version check.</li>
</ul>
...
<a name="2.5.31"></a>
<h4>Changes in beta release 2.5.31 (09-Aug-2010) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:</li>
  <li> Bug fixes:</li>
...
<a name="2.5.30"></a>
<h4>Changes in beta release 2.5.30 (09-May-2010) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:</li>
  <li> Support libpng 1.4.0's slightly newer API.</li>
  <li> Bug fixes:</li>
  <li> Don't lazy match AnyContext when printing out bindings and the    contexts they apply to with &quot;PrintInfo Bindings&quot;.</li>
</ul>
