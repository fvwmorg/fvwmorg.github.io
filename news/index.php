...
<a name="2.5.20"></a>
<h4>Changes in beta release 2.5.20 (not released yet) <a href="#top">[top]</a></h4>
<ul>
  <li> New features:</li>
  <li> Bug Fixes:</li>
</ul>
...
<ul>
  ...
  <li> Security fix for fvwm-menu-directory.  Se BugTraq id 9161.</li>
</ul>
...
<ul>
  <li> Module configuration syntax now accepts a delimiter - colon and  optional spaces; the old syntax is supported as usual (but it  allows conflicts):
    <ul>
        <li>    *FvwmIconBoxMaxIconSize 48x48</li>
        <li>    *FvwmIconBox: MaxIconSize 48x48</li>
    </ul>
  </li>
...
<ul>
  <li> KillModule supports an optional alias parameter as given in  Module.
    <ul>
        <li>    Module FvwmModule Alias</li>
        <li>    KillModule FvwmModule Alias</li>
    </ul>
  </li>
</ul>
...
<ul>
  <li> Renamed the MovedButton3 condition to PlacedByButton3.</li>
...
<ul>
  ...
  <li> New command IgnoreModifiers for ignoring the pesky num-lock key  with key and mouse bindings.  Hint: try this command with  XFree86:
    <ul>
        <li>    IgnoreModifiers L25</li>
    </ul>
    If you encounter performance problems please consult the manpage  and the FAQ.</li>
  ...
  <li> Lots of changes to FvwmForm:  No limits of form size.  Fonts and colors can change anywhere in the form.  Form appearance can be configured globally:
    ...
    Forms can be read in directly from a file.  Some forms are installed automatically.  Tab to previous field.  You can control vertical spacing on text so spacing is OK for  help panels. A button can execute a synchronous shell command.  You can paste into a form  Forms can read configuration data.</li>
...
<a name="2.2.0"></a>
<h4>Changes in official release 2.2.0 (February 1999) <a href="#top">[top]</a></h4>
