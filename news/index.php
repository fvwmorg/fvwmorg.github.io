...
<a name="2.5.14"></a>
<h4>Changes in beta release 2.5.14 (not released yet) <a href="#top">[top]</a></h4>
<a name="2.5.13"></a>
...
<ul>
  ...
  <li> MoveToPage command:    New options wrapx, wrapy, nodesklimitx and nodesklimity.    New suffix 'w' to allow for window relative movement.</li>
</ul>
...
<ul>
  ...
  <li> Security fixes in:    fvwm-menu-directory (BugTraq id 9161)    fvwm_make_directory_menu.sh    fvwm_make_browse_menu.sh</li>
</ul>
...
<ul>
  ...
  <li> New option StartCommand for FvwmTaskBar to allow placing the  StartMenu correctly.    *FvwmTaskBar: StartCommand Popup RootMenu \        rectangle $widthx$height+$left+$top 0 -100m  Please refer to the FvwmTaskBar man page for details.</li>
